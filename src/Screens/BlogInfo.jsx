...
export default function BlogInfo() {
    ...
    return (
        <>
            ...
            >
                <motion.div
                    className='bg-white flex flex-col items-center self-center scroll-smooth w-[78%] mt-[100px]'
                >
                    ...
                    <p className=' font-MundoRegular text-lg self-start text-gray-700'>
                        {state?.date} | <span className='font-MundoBold'>{state?.category}</span> 
                    </p>
                    <img
                        src={state?.image}
            ...
            >
                <motion.div
                    className='bg-white flex font-MundoRegular flex-col items-start text-start self-center scroll-smooth w-[68%] mt-[100px]'
                >
            ...
            >
                ...
                >
                    <p className=' font-MundoBold uppercase'>
