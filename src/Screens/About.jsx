        ...
        <motion.div className=' font-MundoBold w-[78%] border-t flex justify-between py-20  self-center '>
          ...
          <div className='flex flex-col w-[50%] space-y-5'>
            <p className=' font-MundoRegular text-2xl  text-white'>
              ...
              <br /> <br />
              We set a personal benchmark every time we crack an idea, do
              research, execute strategies or typically everything else, and the
              next time we're at it, we simply do not accept anything less. That
              is how we keep setting our standards. That is how we keep building
              brands.
            </p>
            <hr className='h-[1px]' />
            <p className=' font-MundoRegular text-4xl  text-white'>
              We believe in standardizing the process before beginning to work
              on anything. We ask ourselves, how can this be made simple? Simple
              yet significant.
              <br /> <br />
              What more do we need to know? What questions do we need to ask?
              What steps can be taken to reach the next level? The right answers
              to these questions help bring the right results. And this is what
              pushes us in our journey of becoming one of the best branding
              companies in India.
            </p>
          </div>
        </motion.div>
        ...
        <motion.div className=' font-MundoBold w-[78%] flex justify-between py-20  self-center '>
          ...
          <div className='flex flex-col w-[50%] space-y-5'>
            <p className=' font-MundoRegular text-4xl pt-20  text-black'>
              ...
              <br /> <br />
              We generate ideas, just by बातचीत (conversations). Sometimes
              बातचीत becomes बकवास also, but we know when to stop. :) When in an
              intense बातचीत, we forget to drink, eat or take breaks.
              <br /> <br />
        ...
        <motion.div className=' font-MundoBold w-[78%] border-t self-center flex justify-between py-20'>
          ...
          <div className='flex flex-col w-[50%] space-y-5'>
            <p className=' font-MundoRegular text-2xl  text-black'>
              ...
              company. Over the last 4 years, we learnt a lot, enjoyed a lot and
              made our mark nationally & internationally. We take pride in
              calling ourselves <span className=' font-MundoI'>'nerd'</span> and
              this feeling fills us up & thrills us to keep going, keep
              hustling.
            </p>
            <hr className='h-[1px]' />
            <p className=' font-MundoRegular text-4xl pt-20  text-black'>
              Being a <span className=' font-MundoI'>nerd</span> is knowing what
              it feels like to have almost everyday filled with enthusiasm &
              excitement. We work together. We argue endlessly. We run
              marathons. We play games. We smash boundaries. We grow together.
              We do it all.
              <br /> <br />
              Ah, we really can't express in words what being a{' '}
              <span className=' font-MundoI'>nerd</span> is like!
            </p>
          </div>
        </motion.div>
      </motion.div>
        ...
        <motion.div className=' font-MundoBold w-[78%] border-t self-center flex justify-between py-20'>
          ...
          <div className='flex flex-col w-[50%] space-y-5'>
            <p className=' font-MundoRegular text-2xl  text-black'>
              ...
              <br />
              <br />
              Can't keep count, can you? Look around you, the world is becoming
              digital and the pace at which the digital world is growing is
              unimaginable. And unstoppable.
            </p>
          </div>
        </motion.div>
        <motion.button
          ...
          <p className=' font-MundoBold'>Start a Project?</p>
        </motion.button>
      </motion.div>
      <motion.div className=' w-full  bg-white flex flex-col items-center justify-start scroll-smooth'>
        <motion.div className=' font-MundoBold w-[78%] border-t self-center flex justify-between py-20'>
          <p className=' font-MundoRegular text-6xl  text-black'>
            For 4+ years, as a software & creative branding agency, we have
            built experiences. For our clients and their customers.
          </p>
        </motion.div>
      </motion.div>
      <Footer />
