          ...
          <div className='w-full h-[100vh]   flex flex-col bg-black '>
            ...
            <div className='flex flex-col items-center justify-between h-[100vh] py-10 w-[78%] self-center '>
              <div className=' w-[50%]  flex flex-wrap self-start items-center justify-between'>
                ...
                <motion.a className='hover:text-blue-400 py-2  font-MundoBold text-7xl font-black text-white '>
                  Projects
                </motion.a>
                <motion.a className='hover:text-blue-400 py-2  font-MundoBold text-7xl font-black text-white '>
                  Team
              ...
              <div className=' w-[100%] flex justify-between space-y-4 '>
                <button className=' font-MundoBold hover:text-blue-400 text-7xl font-black text-white '>
                  Contact
                </button>
                <div className='flex w-[60%] flex-col items-start space-y-3'>
                  <button className=' font-MundoRegular hover:text-blue-400 text-xl font-black text-white '>
                    +91 9405649047
                  </button>
                  <button className=' font-MundoRegular hover:text-blue-400 text-xl font-black text-white '>
                    contact@nerdtech.in
                  ...
                  <div className='flex space-x-4'>
                    <button className=' font-MundoRegular hover:text-blue-400 text-base  text-gray-500 '>
                      Instagram
                    </button>
                    <button className=' font-MundoRegular hover:text-blue-400 text-base  text-gray-500 '>
                      Facebook
